      ...
      <div className="container mx-auto">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
          <div className="w-full md:w-1/2 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <h2 className="text-lg font-medium text-portfolio-purple mb-2">Hello, I'm</h2>
            <h1 className="text-4xl md:text-6xl font-bold mb-4">John Doe</h1>
            <h3 className="text-2xl md:text-3xl font-medium text-gray-700 mb-6">Frontend Developer</h3>
            <p className="text-lg text-gray-600 mb-8 max-w-lg">
              I build responsive, accessible, and performant web applications using modern technologies.
              Passionate about creating exceptional user experiences.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="bg-portfolio-purple hover:bg-portfolio-indigo text-white px-8 py-6 rounded-md" size="lg" asChild>
                <a href="#projects">View My Work</a>
              </Button>
              <Button variant="outline" className="border-portfolio-purple text-portfolio-purple hover:bg-portfolio-purple/10 px-8 py-6 rounded-md" size="lg" asChild>
